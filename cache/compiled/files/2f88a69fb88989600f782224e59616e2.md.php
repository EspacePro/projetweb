...
return [
    ...
    'filename' => '/var/www/html/sites_tests/gateway/user/pages/04.style-guide/default.md',
    'modified' => 1665247254,
    'size' => 2163,
    'data' => [
        'header' => [
...
body_classes: page page-template-default group-blog',
        'markdown' => 'The style guide provides you with a blueprint of Gateway’s default post and page styles. The style guide is also a great reference for suggested typographic treatment and styles for your content.
