...
return [
    ...
    'filename' => '/var/www/html/sites_tests/gateway/user/pages/02.blog/tristique-pellentesque-ipsam-rhoncus-fusce/item.md',
    'modified' => 1665247254,
    'size' => 1039,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Tristique, pellentesque ipsam rhoncus fusce
date: 13:34 05/26/2014
author: Rescue Themes
body_classes: single single-post postid-15 single-format-standard group-blog
taxonomy:
    category: Showshoe
    tag: [eight, seventh]',
        'markdown' => 'Qui placeat aperiam cupidatat pede porro praesent perspiciatis montes perspiciatis debitis sunt? Quos senectus, quia deleniti? Quasi, scelerisque, taciti, sunt. Sagittis justo! Mollis maiores nisl.
