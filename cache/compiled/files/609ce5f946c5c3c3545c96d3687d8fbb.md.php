...
return [
    ...
    'filename' => '/var/www/html/sites_tests/gateway/user/pages/03.pages/03.fullwidth/default.md',
    'modified' => 1665247254,
    'size' => 1013,
    'data' => [
        'header' => [
        ...
        'frontmatter' => 'title: Fullwidth
body_classes: page page-template-default group-blog
fullwidth: true',
        'markdown' => 'Nullam id dolor id nibh ultricies vehicula ut id elit. Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Aenean lacinia bibendum nulla sed consectetur. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec ullamcorper nulla non metus auctor fringilla.
